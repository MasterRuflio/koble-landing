    ...
    <div className="bg-white py-16 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-4 text-lg leading-8 text-gray-600">Somos un grupo diverso de individuos apasionados por lo que hacen.</p>
        </div>
        <ul role="list" className="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          ...
          <li className="group hover:scale-105 transform transition-all ease-in-out duration-500">
            ...
            <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-600">Javier Cordero</h3>
          ...
          <li className="group hover:scale-105 transform transition-all ease-in-out duration-500">
            ...
            <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-600">Guillermo Salles</h3>
          ...
          <li className="group hover:scale-105 transform transition-all ease-in-out duration-500">
            ...
            <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-600">Esteban Dworak</h3>
          ...
          <li className="group hover:scale-105 transform transition-all ease-in-out duration-500">
            ...
            <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-600">Saul Gallegos</h3>
          ...
          <li className="group hover:scale-105 transform transition-all ease-in-out duration-500">
            ...
            <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-600">Jaime Lopez-Hidalgo</h3>
          ...
          <li className="group hover:scale-105 transform transition-all ease-in-out duration-500">
            ...
            <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-600">Esteban Ortiz</h3>
            <p className="text-sm font-semibold leading-6 text-indigo-500 group-hover:text-pink-500 transition-all ease-in-out duration-500">Frontend Web Developer</p>
            <ul role="list" className="mt-6 flex justify-center gap-x-6">
              {/* <li>
                <a href="#" className="text-gray-300 hover:text-gray-400">
          ...
          <li className="group hover:scale-105 transform transition-all ease-in-out duration-500">
            ...
            <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-600">Jose Salcedo</h3>
            ...
            <ul role="list" className="mt-6 flex justify-center gap-x-6">
              ...
              <li>
                <a href="https://www.linkedin.com/in/jose-salcedo-uribe-b7b04a275/" target="_blank" className="text-gray-300 hover:text-gray-400">
                  <span className="sr-only">LinkedIn</span>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path fill-rule="evenodd" d="M16.338 16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601 2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778 3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337 9.763H6.34v-8.59H3.667v8.59zM17.668 1H2.328C1.595 1 1 1.581 1 2.298v15.403C1 18.418 1.595 19 2.328 19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" clip-rule="evenodd" />
                  </svg>
          ...
          <li className="group hover:scale-105 transform transition-all ease-in-out duration-500">
            ...
            <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-600">Carlos Gonzalez</h3>
          ...
          <li className="group hover:scale-105 transform transition-all ease-in-out duration-500">
            ...
            <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-600">Mateo Gonzalez</h3>
          ...
          <li className="group hover:scale-105 transform transition-all ease-in-out duration-500">
            ...
            <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-600">Lucía Vela</h3>
            ...
            <ul role="list" className="mt-6 flex justify-center gap-x-6">
              ...
              <li>
                <a href="https://www.linkedin.com/in/lucia-vela-gonzalez-98ba51287/" target="_blank" className="text-gray-300 hover:text-gray-400">
                  <span className="sr-only">LinkedIn</span>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path fill-rule="evenodd" d="M16.338 16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601 2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778 3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337 9.763H6.34v-8.59H3.667v8.59zM17.668 1H2.328C1.595 1 1 1.581 1 2.298v15.403C1 18.418 1.595 19 2.328 19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" clip-rule="evenodd" />
                  </svg>
